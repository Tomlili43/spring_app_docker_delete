...
public class OpenAPIConfig {
    ...
    public OpenAPI myOpenAPI() {
        ...
        contact.setEmail("aift@gmail");
        contact.setName("aift");
        contact.setUrl("https://hkaift.com/");
        ...
        Info info = new Info()
                ...
                .version("1.0")
                .contact(contact)
                .description("This API exposes endpoints to manage Data Visualization.").termsOfService("https://www.bezkoder.com/terms")
                .license(mitLicense);
