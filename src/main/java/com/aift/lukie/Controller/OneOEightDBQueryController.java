...
import com.aift.lukie.Service.aggregatedService.AggOneOEightDBService;
...
@RestController
@RequestMapping(value="/108database")
public class OneOEightDBQueryController {
    @Autowired
    private  AggOneOEightDBService aggOneOEightDBService;
    ...
    public ResponseEntity<Object> findByProductId(@RequestBody HashMap<String,Object> jsonParam) {
        ...
        try{
            Object res =(Object) aggOneOEightDBService.findByPid(jsonParam);
    ...
    public ResponseEntity<Object> findBySellerId(@RequestBody HashMap<String,Object> jsonParam) {
        // System.out.println(jsonParam.toString());
        try{
            Object res = (Object) aggOneOEightDBService.findBySid(jsonParam);
            return ResponseHandler.generateResponse("SUCCESS", HttpStatus.OK, res);
        } catch(Exception e) {
            return ResponseHandler.generateResponse(e.getMessage(), HttpStatus.MULTI_STATUS, null);
        }
    ...
    public ResponseEntity<Object> findByProductIdAndSellerId(@RequestBody HashMap<String,Object> jsonParam) {
        // System.out.println(jsonParam.toString());
        try{
            Object res = aggOneOEightDBService.findByPidAndSid(jsonParam);
            return ResponseHandler.generateResponse("SUCCESS", HttpStatus.OK, res);
        } catch(Exception e) {
            return ResponseHandler.generateResponse(e.getMessage(), HttpStatus.MULTI_STATUS, null);
        }
