...
@Entity
@Table(name="unique_products_by_month_dm_pb")
@Getter
public class UniqueProductsByMonthDmPb implements Serializable {

    public UniqueProductsByMonthDmPb(){}

    public <K> UniqueProductsByMonthDmPb(HashMap<String,K> other)throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
    ...
    " id: "+id+
            " }"    );}
    public UniqueProductsByMonthDmPb setAllElements(HashMap<String,Object> jsonParam) throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException{
