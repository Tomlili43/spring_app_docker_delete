...
@Entity
@Table(name="us_transaction_volume_cn")
@Getter
public class UsTransactionVolumeCn implements Serializable {

    public UsTransactionVolumeCn(){}

    public <K> UsTransactionVolumeCn(HashMap<String,K> other)throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
    ...
    " year: "+year+
            " }"    );}
    public UsTransactionVolumeCn setAllElements(HashMap<String,Object> jsonParam) throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException{
