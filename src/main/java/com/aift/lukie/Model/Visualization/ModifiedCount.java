...
@Entity
@Table(name="modified_count")
@Getter
public class ModifiedCount implements Serializable {

    public ModifiedCount(){}

    public <K> ModifiedCount(HashMap<String,K> other)throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
    ...
    " id: "+id+
            " }"    );}
    public ModifiedCount setAllElements(HashMap<String,Object> jsonParam) throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException{
