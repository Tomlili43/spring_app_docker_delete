...
@Entity
@Table(name="modified_count_data_product_pb")
@Getter
public class ModifiedCountDataProductPb implements Serializable {

    public ModifiedCountDataProductPb(){}

    public <K> ModifiedCountDataProductPb(HashMap<String,K> other)throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
    ...
    " id: "+id+
            " }"    );}
    public ModifiedCountDataProductPb setAllElements(HashMap<String,Object> jsonParam) throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException{
