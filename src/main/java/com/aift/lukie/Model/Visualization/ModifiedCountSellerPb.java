...
@Entity
@Table(name="modified_count_seller_pb")
@Getter
public class ModifiedCountSellerPb implements Serializable {

    public ModifiedCountSellerPb(){}

    public <K> ModifiedCountSellerPb(HashMap<String,K> other)throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
    ...
    " id: "+id+
            " }"    );}
    public ModifiedCountSellerPb setAllElements(HashMap<String,Object> jsonParam) throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException{
