...
@Entity
@Table(name="unique_products_by_month_dm")
@Getter
public class UniqueProductsByMonthDm implements Serializable {

    public UniqueProductsByMonthDm(){}

    public <K> UniqueProductsByMonthDm(HashMap<String,K> other)throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
    ...
    " id: "+id+
            " }"    );}
    public UniqueProductsByMonthDm setAllElements(HashMap<String,Object> jsonParam) throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException{
