...
@Entity
@Table(name="modified_count_data_product")
@Getter
public class ModifiedCountDataProduct implements Serializable {

    public ModifiedCountDataProduct(){}

    public <K> ModifiedCountDataProduct(HashMap<String,K> other)throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
    ...
    " id: "+id+
            " }"    );}
    public ModifiedCountDataProduct setAllElements(HashMap<String,Object> jsonParam) throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException{
