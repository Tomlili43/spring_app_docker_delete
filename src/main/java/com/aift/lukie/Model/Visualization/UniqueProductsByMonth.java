...
@Entity
@Table(name="unique_products_by_month")
@Getter
public class UniqueProductsByMonth implements Serializable {

    public UniqueProductsByMonth(){}

    public <K> UniqueProductsByMonth(HashMap<String,K> other)throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
    ...
    " id: "+id+
            " }"    );}
    public UniqueProductsByMonth setAllElements(HashMap<String,Object> jsonParam) throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException{
