...
@Entity
@Table(name="modified_count_data_month")
@Getter
public class ModifiedCountDataMonth implements Serializable {

    public ModifiedCountDataMonth(){}

    public <K> ModifiedCountDataMonth(HashMap<String,K> other)throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
    ...
    " id: "+id+
            " }"    );}
    public ModifiedCountDataMonth setAllElements(HashMap<String,Object> jsonParam) throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException{
