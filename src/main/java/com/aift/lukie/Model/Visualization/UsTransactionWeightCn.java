...
@Entity
@Table(name="us_transaction_weight_cn")
@Getter
public class UsTransactionWeightCn implements Serializable {

    public UsTransactionWeightCn(){}

    public <K> UsTransactionWeightCn(HashMap<String,K> other)throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
    ...
    " year: "+year+
            " }"    );}
    public UsTransactionWeightCn setAllElements(HashMap<String,Object> jsonParam) throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException{
