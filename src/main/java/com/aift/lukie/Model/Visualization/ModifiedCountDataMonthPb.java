...
@Entity
@Table(name="modified_count_data_month_pb")
@Getter
public class ModifiedCountDataMonthPb implements Serializable {

    public ModifiedCountDataMonthPb(){}

    public <K> ModifiedCountDataMonthPb(HashMap<String,K> other)throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
    ...
    " id: "+id+
            " }"    );}
    public ModifiedCountDataMonthPb setAllElements(HashMap<String,Object> jsonParam) throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException{
