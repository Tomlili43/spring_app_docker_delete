...
@Entity
@Table(name="us_transaction_count_cn")
@Getter
public class UsTransactionCountCn implements Serializable {

    public UsTransactionCountCn(){}

    public <K> UsTransactionCountCn(HashMap<String,K> other)throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
    ...
    " year: "+year+
            " }"    );}
    public UsTransactionCountCn setAllElements(HashMap<String,Object> jsonParam) throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException{
