...
@Entity
@Table(name="modified_count_seller")
@Getter
public class ModifiedCountSeller implements Serializable {

    public ModifiedCountSeller(){}

    public <K> ModifiedCountSeller(HashMap<String,K> other)throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
    ...
    " id: "+id+
            " }"    );}
    public ModifiedCountSeller setAllElements(HashMap<String,Object> jsonParam) throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException{
