...
@Entity
@Table(name="modified_count_seller_products")
@Getter
public class ModifiedCountSellerProducts implements Serializable {

    public ModifiedCountSellerProducts(){}

    public <K> ModifiedCountSellerProducts(HashMap<String,K> other)throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
    ...
    " id: "+id+
            " }"    );}
    public ModifiedCountSellerProducts setAllElements(HashMap<String,Object> jsonParam) throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException{
