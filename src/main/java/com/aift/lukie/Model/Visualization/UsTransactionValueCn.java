...
@Entity
@Table(name="us_transaction_value_cn")
@Getter
public class UsTransactionValueCn implements Serializable {

    public UsTransactionValueCn(){}

    public <K> UsTransactionValueCn(HashMap<String,K> other)throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
    ...
    " year: "+year+
            " }"    );}
    public UsTransactionValueCn setAllElements(HashMap<String,Object> jsonParam) throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException{
