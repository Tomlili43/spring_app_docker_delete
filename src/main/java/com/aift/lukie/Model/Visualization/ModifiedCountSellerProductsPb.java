...
@Entity
@Table(name="modified_count_seller_products_pb")
@Getter
public class ModifiedCountSellerProductsPb implements Serializable {

    public ModifiedCountSellerProductsPb(){}

    public <K> ModifiedCountSellerProductsPb(HashMap<String,K> other)throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
    ...
    " id: "+id+
            " }"    );}
    public ModifiedCountSellerProductsPb setAllElements(HashMap<String,Object> jsonParam) throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException{
