...
@Entity
@Table(name="modified_times_pb")
@Getter
public class ModifiedTimesPb implements Serializable {

    public ModifiedTimesPb(){}

    public <K> ModifiedTimesPb(HashMap<String,K> other)throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
    ...
    " name: "+name+
            " }"    );}
    public ModifiedTimesPb setAllElements(HashMap<String,Object> jsonParam) throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException{
